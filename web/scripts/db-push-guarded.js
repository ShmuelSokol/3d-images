 ...
 *
 * Context: on 2026-04-19 OCR Hebrew's entire schema was wiped by a stray
 * `prisma db push` from a sibling project sharing the same Supabase. This
 * guard prevents a recurrence.
 *
 * Usage:
...
const CRITICAL_TABLES = ["user", "image", "coupon", "couponRedemption", "payment", "ticket"];

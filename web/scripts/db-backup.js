#!/usr/bin/env node
/**
 * Export all 3D Images tables to a timestamped JSON file.
 * Non-destructive, pure read. Designed for cron.
 *
 * Usage:
 *   node scripts/db-backup.js                # writes backups/db-YYYY-MM-DD.json
...
const TABLES = ["user", "image", "coupon", "couponRedemption", "payment", "ticket"];

...
async function main() {
  const statements = [
    ...
    // Pro subscription (2026-03-23)
    `ALTER TABLE td_user ADD COLUMN IF NOT EXISTS plan TEXT NOT NULL DEFAULT 'free'`,
    `ALTER TABLE td_user ADD COLUMN IF NOT EXISTS "stripeCustomerId" TEXT`,
    `ALTER TABLE td_user ADD COLUMN IF NOT EXISTS "stripeSubscriptionId" TEXT`,
